...
TEST(ArithmeticsTest, SumMatrix_7) {
  S21Matrix summand_1{};
  S21Matrix summand_2{};
...
TEST(ArithmeticsTest, SubMatrix_7) {
  S21Matrix summand_1{};
  S21Matrix summand_2{};
...
TEST(ArithmeticsTest, MulMatrix_4) {
  S21Matrix multiplier_1{};
  S21Matrix multiplier_2{};
...
TEST(OtherTest, CalcComplements_4) {
  S21Matrix Matrix(1, 1);
  S21Matrix ComplementsMatrix(1, 1);

  Matrix(0, 0) = -2;

  ComplementsMatrix(0, 0) = -2;
...
TEST(OperatorTest, OpBracket_1) {
  ...
  EXPECT_THROW(Matrix(-1, 25), std::out_of_range);
}
